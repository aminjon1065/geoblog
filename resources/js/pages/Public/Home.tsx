...
export default function Home() {
    ...
    const activities: Activity[] = [
        ...
        },
        {
            ...
            description: t.activity_mining_desc ?? 'Поддержка устойчивого развития горнодобывающего сектора.',
        },
        {
            icon: BookOpen,
            title: t.activity_education ?? 'Образование',
            description: t.activity_education_desc ?? 'Подготовка специалистов и повышение квалификации.',
        },
        {
            icon: Users,
            title: t.activity_community ?? 'Сообщество',
            description: t.activity_community_desc ?? 'Сеть профессионалов геологической отрасли.',
        },
    ];
