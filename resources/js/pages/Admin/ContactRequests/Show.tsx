...
export default function ContactRequestShow({ contactRequest }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: contactRequest.name, href: `/admin/contact-requests/${contactRequest.id}` },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    <Heading title={contactRequest.name} description={`Received on ${new Date(contactRequest.created_at).toLocaleDateString()}`} />
                ...
                <div className="max-w-2xl rounded-lg border p-6">
                    <dl className="space-y-4">
                        ...
                        <div>
                            ...
                            <dd className="mt-1">
                                <a href={`mailto:${contactRequest.email}`} className="text-primary hover:underline">
                        ...
                        <div>
                            ...
                            <dd className="mt-1 uppercase">{contactRequest.locale}</dd>
                        </div>
                        <div>
