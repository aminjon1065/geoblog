        ...
        <footer className="border-t border-border bg-secondary">
            <div className="mx-auto max-w-7xl px-6 py-12">
                <div className="grid gap-10 md:grid-cols-3">
                    {/* Brand */}
                    <div>
                        <Link href={url('', locale)} className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="space-y-3 text-sm">
                            <div className="flex gap-2.5 text-foreground/70">
                                ...
                                <span>{t.address_value ?? 'г. Душанбе, Таджикистан'}</span>
                            </div>
                            <div className="flex gap-2.5 text-foreground/70">
                            ...
                            <div className="flex gap-2.5 text-foreground/70">
                                ...
                                <span>{t.phone_value ?? '+992 (37) 221-00-00'}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="border-t border-border">
                <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 text-xs text-muted-foreground">
                    <p>&copy; {new Date().getFullYear()} {t.org_copyright ?? 'Ассоциация Геологов Таджикистана.'}</p>
                </div>
            </div>
        </footer>
    );
